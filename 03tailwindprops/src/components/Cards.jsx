...
import hero from "../assets/jj.avif";

export default function Cards({ mission, btnMsg = "No misson details" }) {
  return (
    <div className="md:max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:scale-105 group">
      <div className="relative overflow-hidden rounded-lg mb-6">
        <img
          ...
          width={400}
          height={300}
          className="object-cover object-center w-full transition-transform duration-300 group-hover:scale-110"
        />
